    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="flex justify-between items-center p-4 bg-white">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="/join" className="border border-primary text-primary px-6 py-2 rounded">
            Join
          </a>
          <a href="/login" className="bg-primary text-primary-foreground px-6 py-2 rounded">
            Login
          </a>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            <div className="flex flex-col items-start">
              ...
              <a href="/signup" className="mt-auto bg-primary text-primary-foreground px-6 py-2 rounded">
                Sign Up
              </a>
            </div>
            <div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm">Stunting in children can have long term effect on their growth and development</p>
              <p className="text-sm">cegahstuntinguh@gmail.com</p>
            </div>
            <div className="flex flex-col items-center">
              <Phone className="h-12 w-12 mb-2" />
              <h3 className="font-bold mb-2">Phone</h3>
              <p className="text-sm">Stunting in children can have long term effect on their growth and development</p>
              <p className="text-sm">+92 321 110 50 50</p>
            </div>
            <div className="flex flex-col items-center">
              <Building className="h-12 w-12 mb-2" />
              <h3 className="font-bold mb-2">Office</h3>
              <p className="text-sm">Stunting in children can have long term effect on their growth and development</p>
              <p className="text-sm">Punjab Small Industries Housing</p>
            </div>
          </div>
        </div>
      </footer>
